...
public class HazelcastRunner implements Runnable{
    ...
    private static Logger logger = Logger.getLogger(HazelcastRunner.class);
    ...
    public ApplicationContext loadSpringContainer() {
        String springContextFile = "hazelcast-context.xml";
    ...
    public static void main(String[] args) throws Exception {
        HazelcastRunner app = new HazelcastRunner();
    ...
    public static class ShutdownHook extends Thread {
        private final HazelcastRunner instance;

        public ShutdownHook(HazelcastRunner instance) {
    ...
    public static class Handler implements Runnable {
        ...
        private final HazelcastRunner parent;
        ...
        public Handler(Socket s, HazelcastRunner p) {
            super();
            this.socket = s;
            this.parent = p;
        }
